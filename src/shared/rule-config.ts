...
export const RULE_CONFIG = {
  ...
  addressPolicy: 'Provide a street/site identifier, city/locality, and state/region or postal code. The US-style demo accepts a comma-separated full address (for example: 123 Example Lane, Exampleton, CA 90001), or separately entered components. Ambiguous raw text remains unresolved. This formatting heuristic does not verify geography, address existence, or serviceability.',
